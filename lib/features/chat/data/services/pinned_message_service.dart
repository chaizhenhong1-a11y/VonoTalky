...
class PinnedMessageService {
  PinnedMessageService({FirebaseFirestore? firestore, FirebaseAuth? auth})
  ...
  Stream<Map<String, dynamic>> groupPreferences(String groupId) => _preference(
    'group_$groupId',
  ...
  String _preview(Map<String, dynamic> data) {
    ...
    final value = (data['text'] as String? ?? '').replaceAll('\n', ' ').trim();
