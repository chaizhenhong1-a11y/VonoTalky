              ...
              StreamBuilder<Map<String, Map<String, dynamic>>>(
                ...
                builder: (context, preferenceSnapshot) {
                  ...
                  final items = <_ArchivedItem>[
                    ...
                    ...groupSnapshot.data!
                        .map((group) => _ArchivedItem.group(group, preferences))
                        .where((item) => item.archived),
                        ...
                        return _ArchivedGroupTile(
                          ...
                          onUnarchive: () async {
                            ...
                            if (context.mounted) {
                              _showMessage(
                                context,
                                'Group restored to Recent Chats',
                              );
                            }
                          },
                        );
  ...
  Widget build(BuildContext context) => Material(
    ...
    child: ListTile(
      ...
      trailing: IconButton(
        ...
        icon: const Icon(Icons.unarchive_outlined, color: Color(0xFF805BB3)),
      ),
      onTap: onTap,
    ),
  );
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(icon, size: 34, color: const Color(0xFF805BB3)),
          ),
...
class _ArchivedItem {
  ...
  factory _ArchivedItem.group(
    ...
    archived: preferences['group_${group.id}']?['archived'] as bool? ?? false,
  );
}
