...
class UnifiedRecentChats extends StatelessWidget {
                        ...
                        itemBuilder: (_, index) {
                            ...
                            return _SwipeActions(
                              ...
                              onReadToggle: () async {
                                if (group.unreadCount > 0) {
                                  ...
                                  await groupRecentChatService.markUnread(
                                    group.id,
                                  );
                                  if (context.mounted) {
                                    _showActionMessage(
                                      context,
                                      'Group marked as unread',
                                    );
                                  }
                                }
                              },
                          ...
                          return FutureBuilder<ChatUser?>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final unread =
                                  data['unreadFor'] == chatService.myId
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _ActionTile(
                      ...
                      onTap: () =>
                          Navigator.pop(sheetContext, _DirectChatAction.open),
                    ),
                  ],
                ),
              ),
  ...
  Future<void> _showGroupChatActions({
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                        '${group.memberCount} members · Group options',
                      ),
                    ),
                    const Divider(height: 1),
                    _ActionTile(
                    ...
                    _ActionTile(
                      ...
                      onTap: () =>
                          Navigator.pop(sheetContext, _GroupChatAction.archive),
                    ),
                    _ActionTile(
                      ...
                      onTap: () =>
                          Navigator.pop(sheetContext, _GroupChatAction.open),
                    ),
                  ],
                ),
              ),
    ...
    try {
      ...
      if (context.mounted) {
        _showActionMessage(context, 'Unable to update this group right now');
      }
    }
  }
...
enum _DirectChatAction { togglePin, markRead, markUnread, archive, open }

enum _GroupChatAction { togglePin, markRead, markUnread, archive, open }
...
class _ThreadItem {
  ...
  factory _ThreadItem.direct(
    ...
    final draftUpdatedAt = (preference['draftUpdatedAt'] as Timestamp?)
        ?.toDate();
