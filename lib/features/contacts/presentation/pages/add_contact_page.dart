...
class _AddContactPageState extends State<AddContactPage> {
  ...
  Future<void> _search() async {
    if (controller.text.trim().length < 2) {
      setState(() => error = 'Enter a full email or at least 2 name characters.');
      return;
    }
...
class _SearchResultTile extends StatelessWidget {
  const _SearchResultTile({required this.user, required this.service, required this.onNotice});
  final ChatUser user;
