                      ...
                      builder: (context, snapshot) {
                        ...
                        final users = snapshot.data!
                            .where((user) {
                              ...
                              final matchesLetter = selectedLetter == null ||
                          ...
                          children: [
                            ListView.separated(
                              ...
                              itemBuilder: (_, index) => _ContactTile(
                                ...
                                onVoiceCall: () => _notice('Voice call is coming next.'),
                                onVideoCall: () => _notice('Video call is coming next.'),
                              ),
                            ),
                            Align(
  ...
  Widget build(BuildContext context) => StreamBuilder<List<FriendRequest>>(
        ...
        builder: (context, snapshot) {
          ...
          return Stack(clipBehavior: Clip.none, children: [
            IconButton(onPressed: onTap, icon: const Icon(Icons.person_add_alt_1_outlined)),
            if (count > 0)
              Positioned(
                right: 5,
                top: 3,
                child: Container(
                  ...
                  child: Text(count > 99 ? '99+' : '$count', style: const TextStyle(color: Colors.white, fontSize: 9, fontWeight: FontWeight.w800)),
                ),
              ),
          ]);
        },
