                        ...
                        children: [
                          ...
                          Expanded(
                            child: _MainAction(
                              ...
                              label: 'Voice',
                              onTap: () => _notice(context, 'Voice calls are coming next.'),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _MainAction(
                              ...
                              label: 'Video',
                              onTap: () => _notice(context, 'Video calls are coming next.'),
                            ),
                          ),
                        ],
                      ),
                        ...
                        builder: (context, snapshot) {
                          ...
                          return _Card(
                            children: [
                              ...
                              const _Divider(),
                              SwitchListTile(
                                secondary: const _SmallIcon(Icons.notifications_off_rounded),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              for (final item in const ['Spam', 'Harassment', 'Fake account', 'Inappropriate content'])
                ListTile(
                  title: Text(item),
        ...
        builder: (dialogContext) => AlertDialog(
          ...
          actions: [
            ...
            FilledButton(
              ...
              style: FilledButton.styleFrom(backgroundColor: const Color(0xFFB14E68)),
              child: Text(action),
            ),
          ],
        ),
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        padding: EdgeInsets.fromLTRB(12, MediaQuery.paddingOf(context).top + 4, 12, 24),
        ...
        child: Column(
          children: [
              ...
              children: [
                CircleAvatar(
                  ...
                  child: user.photoUrl == null
                      ? Text(user.name[0].toUpperCase(), style: const TextStyle(fontSize: 34))
                      : null,
                ),
                if (user.isOnline)
                  Positioned(
            ...
            Text(user.isOnline ? 'Online' : 'Offline', style: const TextStyle(color: Color(0xFF615968))),
...
class _MainAction extends StatelessWidget {
  const _MainAction({required this.icon, required this.label, required this.onTap});
  final IconData icon;
  final String label;
...
class _InfoTile extends StatelessWidget {
  ...
  final String text;
  @override
  Widget build(BuildContext context) => ListTile(leading: _SmallIcon(icon), title: Text(text));
}
...
class _DangerTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
        ...
        title: Text(title, style: const TextStyle(color: Color(0xFFB14E68), fontWeight: FontWeight.w700)),
        trailing: const Icon(Icons.chevron_right_rounded),
      );
}
...
class _SmallIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        width: 38,
        height: 38,
        decoration: BoxDecoration(color: const Color(0xFFF0E8FC), borderRadius: BorderRadius.circular(11)),
...
class _Divider extends StatelessWidget {
  const _Divider();
  @override
  Widget build(BuildContext context) => const Divider(height: 1, indent: 66, color: Color(0xFFEDE8F0));
}
