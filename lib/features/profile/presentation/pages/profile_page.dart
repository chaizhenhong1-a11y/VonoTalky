        ...
        return Scaffold(
          ...
          body: CustomScrollView(
            slivers: [
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                const _Title('User Info'),
                                _UserInfo(
                                  phone: data['phone'] as String? ?? '+1 555-0123',
                                  email: email,
                                  birthDate: data['birthDate'] as String? ?? 'Dec 12, 1993',
                                ),
                              ],
                            ),
                          ),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                          padding: const EdgeInsets.fromLTRB(18, 13, 18, 100),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
          ...
          bottomNavigationBar: embedded ? null : NavigationBar(
            height: 66,
            selectedIndex: 3,
